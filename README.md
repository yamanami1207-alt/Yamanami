...
STONEWORKの加工詳細末尾は、現在の相談フォーム案内を維持しながら、遠方から郵送で依頼できることを追記しています。`RETURN TO HOME`は削除し、ご相談フォームの直後に区切り線を入れて「過去の加工一覧」へ続く構成に変更しました。

最終フッターには次の情報を表示し、電話番号はスマートフォンでタップして発信できます。

```text
有限会社やまなみ銘石
〒579-8011 大阪府東大阪市東石切町1-5-1
TEL：072-985-0131
```

STONEWORKのService構造化データにも、同じ会社名・住所・電話番号を提供元情報として直接記載しています。
